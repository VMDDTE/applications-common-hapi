/**
 * Code adapted from
 * https://github.com/syed-ahmad/accessible-dialog
 * left as ES5 for old browser compatibility
 */
...
(function(global, factory) {
  ...
  function TimeoutWarning($module) {
    ...
    this.text1 = $module.getAttribute('data-warning-text1')
    this.text2 = $module.getAttribute('data-warning-text2')
    this.text3 = $module.getAttribute('data-warning-text3')
    this.textMinute = $module.getAttribute('data-warning-minute')
    this.textSecond = $module.getAttribute('data-warning-second')
    this.redirectText = $module.getAttribute('data-warning-redirect')
  }
  ...
  TimeoutWarning.prototype.countIdleTime = function() {
    let idleTime;
    let milliSecondsBeforeTimeOut = this.idleMinutesBeforeTimeOut * 60000;
  ...
  TimeoutWarning.prototype.startUiCountdown = function() {
    ...
    var textMinute = this.textMinute
    var textSecond = this.textSecond
    var redirectText = this.redirectText
    ...
    (function runTimer() {
      ...
      if (timerExpired) {
        ...
        $countdown.innerHTML = redirectText;
        $accessibleCountdown.innerHTML = redirectText;
